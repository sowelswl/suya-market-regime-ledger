...
当前评价口径已冻结为 [《择时信号评价方法 v1.1》](./EVALUATION_V1_1.md)：每天一条信号，只预测下一交易日的大盘方向。信号适用于大盘宽基，公开统计固定以中证500（000905）作为主代理指标。少于 20 条已揭示记录时不发布胜率结论；v1.0 的错误定义保留在[修订记录](./CORRECTIONS.md)中。
