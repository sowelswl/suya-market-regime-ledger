...
export const SOURCE_NAME = "aistk.public.micro_timing_final_tail_hold_dates:trend5mcx"
...
export function verifyReveal(commitment, reveal) {
  try {
    ...
    if (commitment.source !== SOURCE_NAME || reveal.source !== SOURCE_NAME) return false
